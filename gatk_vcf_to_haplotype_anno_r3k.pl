...
my($vcf,$indelvcf,$regionlist,$keeplist,$noindel,$nointron,$maf,$outpath);
my $usage = "USAGE:\nperl $0 --snp <snp vcf> --indel <indel vcf> --reg <region list> --keep <sample list> --out <outpath> --maf <maf> --noindel\n";
$usage .= "Specified for rice3k, SNP and InDel vcfs are given seperately.\n";
$usage .= "<snp> is the input snp vcf file with snpEff annotation. [Necessary]\n";
$usage .= "<indel> is the input indel vcf file with snpEff annotation. [Necessary]\n";
...
die $usage unless(defined $vcf and defined $indelvcf and defined $regionlist and defined $outpath);
