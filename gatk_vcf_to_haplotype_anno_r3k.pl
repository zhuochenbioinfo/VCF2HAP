...
my($vcf,$indelvcf,$regionlist,$keeplist,$noindel,$nointron,$mincov,$maf,$outpath,$pass,$nohet);
...
$usage .= "<indel> is the input indel vcf file with snpEff annotation. [Optional]\n";
