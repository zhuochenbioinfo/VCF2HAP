...
my($vcf,$annofile,$regionlist,$keeplist,$noindel,$nointron,$maf,$outpath);
my $usage = "USAGE:\nperl $0 --vcf <vcf> --anno <snpEff file> --reg <region list> --keep <sample list> --out <outpath> --maf <maf> --noindel\n";
